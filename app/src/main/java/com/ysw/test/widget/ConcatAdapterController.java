...
import static com.ysw.test.widget.ConcatAdapter.Config.StableIdMode.ISOLATED_STABLE_IDS;
import static com.ysw.test.widget.ConcatAdapter.Config.StableIdMode.NO_STABLE_IDS;
import static com.ysw.test.widget.ConcatAdapter.Config.StableIdMode.SHARED_STABLE_IDS;
import static com.ysw.test.widget.RecyclerView.Adapter.StateRestorationPolicy.ALLOW;
import static com.ysw.test.widget.RecyclerView.Adapter.StateRestorationPolicy.PREVENT;
import static com.ysw.test.widget.RecyclerView.Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY;
...
class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    private void calculateAndUpdateStateRestorationPolicy() {
        Adapter.StateRestorationPolicy newPolicy = computeStateRestorationPolicy();
        if (newPolicy != mConcatAdapter.getStateRestorationPolicy()) {
            mConcatAdapter.internalSetStateRestorationPolicy(newPolicy);
        }
    }

    private Adapter.StateRestorationPolicy computeStateRestorationPolicy() {
        for (NestedAdapterWrapper wrapper : mWrappers) {
            Adapter.StateRestorationPolicy strategy =
