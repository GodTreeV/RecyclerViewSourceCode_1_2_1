 ...
 * {@link com.ysw.test.widget.RecyclerView.Adapter RecyclerView.Adapter}, and will signal the
...
public class AsyncListDiffer<T> {
     ...
     *
     */
    public AsyncListDiffer(@NonNull com.ysw.test.widget.RecyclerView.Adapter adapter,
