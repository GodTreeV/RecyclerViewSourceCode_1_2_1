...
package com.ysw.test.widget;

import static androidx.annotation.RestrictTo.Scope.LIBRARY;

import static com.ysw.test.widget.RecyclerView.DEFAULT_ORIENTATION;
import static com.ysw.test.widget.RecyclerView.NO_POSITION;
import static com.ysw.test.widget.RecyclerView.VERBOSE_TRACING;
...
/**
 * A {@link LayoutManager} implementation which provides
 * similar functionality to {@link android.widget.ListView}.
 */
public class LinearLayoutManager extends LayoutManager implements
     ...
     * {@link #onLayoutChildren(Recycler, State)} is run.
     */
     ...
     * RecyclerView.
     * <p>
     * If you are using a {@link RecycledViewPool}, it might be a good idea to set
     ...
     * @deprecated Use {@link #calculateExtraLayoutSpace(State, int[])} instead.
     */
     ...
     * {@link State#hasTargetScrollPosition()} to find out if a smooth scroll to a
     * position is in progress, and {@link State#getTargetScrollPosition()} to find out
     ...
     */
    protected void calculateExtraLayoutSpace(@NonNull State state,
     ...
     *                                 indices.
     */
    void onAnchorReady(Recycler recycler, State state,
     ...
     */
    private void layoutForPredictiveAnimations(Recycler recycler,
    ...
    private void updateAnchorInfoForLayout(Recycler recycler, State state,
     ...
     */
    private boolean updateAnchorFromChildren(Recycler recycler,
     ...
     */
    private int fixLayoutEndGap(int endOffset, Recycler recycler,
     ...
     * @return The final offset amount for children
     */
    private int fixLayoutStartGap(int startOffset, Recycler recycler,
                                  State state, boolean canOffsetChildren) {
     ...
     * @see #recycleViewsFromStart(Recycler, int, int)
     * @see #recycleViewsFromEnd(Recycler, int, int)
    ...
    void layoutChunk(Recycler recycler, State state,
     ...
     */
    View findReferenceChild(Recycler recycler, State state,
    ...
    static class LayoutState {
        ...
        /**
         * Contains the {@link #calculateExtraLayoutSpace(State, int[])}  extra layout
        ...
        /**
         * The most recent {@link #scrollBy(int, Recycler, State)}
         * amount.
         */
    ...
    static class AnchorInfo {
        ...
        boolean isViewValidAsAnchor(View child, State state) {
            LayoutParams lp = (RecyclerView.LayoutParams) child.getLayoutParams();
