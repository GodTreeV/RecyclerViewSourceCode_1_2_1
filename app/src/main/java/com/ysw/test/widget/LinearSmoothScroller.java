...
/**
 * {@link SmoothScroller} implementation which uses a {@link LinearInterpolator} until
 ...
 * <p>
 * If the {@link LayoutManager} you are using does not implement the
 * {@link SmoothScroller.ScrollVectorProvider} interface, then you must override the
...
public class LinearSmoothScroller extends SmoothScroller {
    ...
    public int calculateDxToMakeVisible(View view, int snapPreference) {
        ...
        final LayoutParams params = (RecyclerView.LayoutParams)
                view.getLayoutParams();
