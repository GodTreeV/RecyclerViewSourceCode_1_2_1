...
/**
 * A {@link LayoutManager} implementations that lays out items in a grid.
 * <p>
...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private void ensureAnchorIsInCorrectSpan(Recycler recycler,
                                             State state, AnchorInfo anchorInfo, int itemDirection) {
    ...
    private int getSpanGroupIndex(Recycler recycler, State state,
                                  int viewPosition) {
        if (!state.isPreLayout()) {
    ...
    @Override
    void collectPrefetchPositionsForLayoutState(State state, LinearLayoutManager.LayoutState layoutState,
    ...
    private void assignSpans(Recycler recycler, State state, int count,
