...
public class PagerSnapHelper extends SnapHelper {
    ...
    private boolean isForwardFling(LayoutManager layoutManager, int velocityX,
                                   int velocityY) {
        if (layoutManager.canScrollHorizontally()) {
            return velocityX > 0;
        } else {
    ...
    private boolean isReverseLayout(LayoutManager layoutManager) {
        ...
        if ((layoutManager instanceof SmoothScroller.ScrollVectorProvider)) {
            SmoothScroller.ScrollVectorProvider vectorProvider =
                    (SmoothScroller.ScrollVectorProvider) layoutManager;
    ...
    @Nullable
    @Override
    protected SmoothScroller createScroller(
        ...
        return new LinearSmoothScroller(mRecyclerView.getContext()) {
            ...
            protected void onTargetFound(@NonNull View targetView,
                                         @NonNull State state, @NonNull Action action) {
     ...
     */
    @Nullable
    private View findCenterView(LayoutManager layoutManager,
